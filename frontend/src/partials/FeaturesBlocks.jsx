      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Comprehensive and versatile features tailored to fit your specific needs</h2>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Constant Reminder</h4>
              <p className="text-gray-600 text-center">With constant reminder, notifications will keep ringing until you handle them.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Repeat Reminder</h4>
              <p className="text-gray-600 text-center">With recurring rules like weekly, monthly, yearly and custom ones at your service, you'll never forget a thing.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">Share lists with friends and colleagues, assign tasks, and improve collaboration.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Filter</h4>
              <p className="text-gray-600 text-center">Easily customize filters like "high-priority tasks for this week" to view quickly.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Theme</h4>
              <p className="text-gray-600 text-center">Choose from 40+ themes to customize your personalized productivity tool.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Statistics</h4>
              <p className="text-gray-600 text-center">Track tasks, focus duration, and habit logs to get a comprehensive view of your progress.</p>
            </div>
